...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Scene/Copy/MemorialCopyScene.js:1
...
(xs.Views.CopyLayer = cc.Layer.extend({
    ...
    xs.Views.Dialog.MemorialDialog.showWithSurrenderInfo(self);
},
    onEnter: function() {
...
(xs.Scene.MemorialCopyScene = cc.Scene.extend({
    name: "xs.Scene.MemorialCopyScene",
    ctor: function() {
    ...
    this.m_pageView.addPageWhitConstruct(xs.Tools.String.createString("MemorialCopyTitle"), xs.Views.CopyLayer, { listener: this, param: {} });
...
(xs.Scene.MemorialCopyScene.create = function(param) {
    var sc;
    // source line 775, bytecode pc 23
    (sc = new xs.Scene.MemorialCopyScene());
    if ((sc && sc.init(param))) {
        // source line 778, bytecode pc 59
        return sc;
    }
    // source line 780, bytecode pc 84
    xs.assert(false, "xs.Scene.MemorialCopyScene.create error!");
    // source line 781, bytecode pc 86
    return null;
});
// source line 787, bytecode pc 640
xs.Scene.Mgr.registerScene("MemorialCopyScene", {
    "class": xs.Scene.MemorialCopyScene,
