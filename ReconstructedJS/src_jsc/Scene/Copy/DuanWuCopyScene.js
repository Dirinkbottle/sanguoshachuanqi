...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Scene/Copy/DuanWuCopyScene.js:1
...
(xs.Views.CopyLayer = cc.Layer.extend({
    ...
    (this.ccb_Node = xs.ccb_reader.load(xs.Cfg.CCBI.DuanWuCopy, this));
    ...
    xs.Views.Dialog.DuanWuDialog.showWithSurrenderInfo(self);
},
    onEnter: function() {
...
(xs.Scene.DuanWuCopyScene = cc.Scene.extend({
    name: "xs.Scene.DuanWuCopyScene",
    ctor: function() {
    ...
    this.m_pageView.addPageWhitConstruct(xs.Tools.String.createString("DuanWuCopyTitle"), xs.Views.CopyLayer, { listener: this, param: {} });
...
(xs.Scene.DuanWuCopyScene.create = function(param) {
    var sc;
    // source line 775, bytecode pc 23
    (sc = new xs.Scene.DuanWuCopyScene());
    if ((sc && sc.init(param))) {
        // source line 778, bytecode pc 59
        return sc;
    }
    // source line 780, bytecode pc 84
    xs.assert(false, "xs.Scene.DuanWuCopyScene.create error!");
    // source line 781, bytecode pc 86
    return null;
});
// source line 787, bytecode pc 640
xs.Scene.Mgr.registerScene("DuanWuCopyScene", {
    "class": xs.Scene.DuanWuCopyScene,
