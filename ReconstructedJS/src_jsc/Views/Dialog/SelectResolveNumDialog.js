...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Views/Dialog/SelectResolveNumDialog.js:1
// source line 144, bytecode pc 472
(xs.Views.Dialog.SelectResolveNumDialog = xs.Views.HungerLayer.extend({
    ctor: function() {
    ...
    // source line 43, bytecode pc 401
    this.m_titleLabel.setStringById("resolveBox_2");
    // source line 44, bytecode pc 425
    this.m_tipLabel.setStringById("resolveBox_3");
    // source line 45, bytecode pc 450
    this.m_openNumLabel.setString(this.selectNum);
    // source line 46, bytecode pc 512
    this.m_openMaxNum.setString((xs.Tools.String.createString("resolveBox_4") + (this.selectNum * 150)));
    // source line 49, bytecode pc 584
    (this.add1Btn = xs.Utils.replaceButton(this.ccbNode, 14, xs.Views.Button.ChangeNumBtn.create(1)));
    // source line 50, bytecode pc 622
    this.add1Btn.setOnClickCallBack(this.onChgNum.bind(this));
    // source line 53, bytecode pc 695
    (this.decrease1Btn = xs.Utils.replaceButton(this.ccbNode, 13, xs.Views.Button.ChangeNumBtn.create(2)));
    // source line 54, bytecode pc 733
    ...
    // source line 69, bytecode pc 1142
    this.m_cancelBtn.setOnClickCallBack(this.onClick.bind(this));
    // source line 70, bytecode pc 1180
    this.m_btnClose.setOnClickCallBack(this.onClose.bind(this));
    // source line 72, bytecode pc 1182
    return true;
},
    setListener: function(listener) {
    // source line 76, bytecode pc 9
    ...
    this.m_openNumLabel.setString((this.selectNum + ""));
    // source line 118, bytecode pc 368
    this.m_openMaxNum.setString((xs.Tools.String.createString("resolveBox_4") + (this.selectNum * 150)));
},
    ...
    // source line 125, bytecode pc 56
    ...
    // source line 127, bytecode pc 110
    ...
    // source line 129, bytecode pc 164
    ...
    // source line 132, bytecode pc 218
    this.m_confirmBtn.setTouchPriority((this.m_baseTouchPriority - 1));
    // source line 133, bytecode pc 245
...
// source line 149, bytecode pc 503
(xs.Views.Dialog.SelectResolveNumDialog.create = function(data) {
    var ret;
    // source line 150, bytecode pc 28
    (ret = new xs.Views.Dialog.SelectResolveNumDialog());
...
// source line 159, bytecode pc 583
xs.Views.Mgr.registerDialog("SelectResolveNumDialog", { "class": xs.Views.Dialog.SelectResolveNumDialog, styleType: xs.Constant_DlgStyleType_Small });
