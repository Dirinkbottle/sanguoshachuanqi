...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Views/Dialog/PublicCopyDialog.js:1
...
// source line 127, bytecode pc 454
(xs.Views.Dialog.JiFenDuiHuanDialogCell = cc.TableViewCell.extend({
    ...
    while (parent) {
        ...
        // source line 120, bytecode pc 121
        (parent = parent.getParent());
    }
},
    onExit: function() {
    // source line 124, bytecode pc 12
    this._super();
},
    ...
    // source line 133, bytecode pc 38
    (this.par = pren);
    // source line 134, bytecode pc 48
    (this.m_itemData = params);
    // source line 136, bytecode pc 67
...
// source line 415, bytecode pc 947
(xs.Views.Dialog.PublicCopyDialog = xs.Views.HungerLayer.extend({
    name: "xs.Views.Dialog.PublicCopyDialog",
    cfg: {
    ...
    var left_sprite, node, _fileName, m_kunYu;
    if (!this._super()) {
        // source line 229, bytecode pc 19
        return false;
    }
    // source line 232, bytecode pc 29
    (this.parent = parent);
    // source line 234, bytecode pc 41
    (this.iconDataList = []);
    // source line 236, bytecode pc 49
    (this.btnClose = null);
    // source line 237, bytecode pc 57
    (this.btnUpdate = null);
    // source line 239, bytecode pc 127
    (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyPublic));
    // source line 240, bytecode pc 157
    ...
    (parent = self.parent);
    // source line 298, bytecode pc 48
    xs.Views.Mgr.hideDialog();
    // source line 299, bytecode pc 63
    parent.updateSpiritStoneNum();
},
    updateInfo: function(resData, isInit) {
    // source line 305, bytecode pc 25
    (this.iconDataList = (resData.item_list || []));
    // source line 306, bytecode pc 95
    (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyPublic));
    // source line 307, bytecode pc 112
    ...
    if (isInit) {
        ...
        // source line 326, bytecode pc 74
        this.refreshIconList();
    }
},
    onEnter: function() {
    // source line 332, bytecode pc 12
    this._super();
},
    onExit: function() {
    // source line 336, bytecode pc 12
    this._super();
},
    setBaseTouchPriority: function(priority) {
    // source line 340, bytecode pc 9
    (this.m_baseTouchPriority = priority);
    // source line 341, bytecode pc 51
    this.btnClose.setTouchPriority((this.m_baseTouchPriority + this.cfg.btnClose.priority));
    // source line 342, bytecode pc 78
    ...
    if (xs.Utils.isEmpty(itemData)) {
        // source line 348, bytecode pc 37
        return void 0;
    }
    // source line 350, bytecode pc 42
    (promptStr = null);
    // source line 351, bytecode pc 87
    (itemName = xs.Tools.String.createString(itemData.item_name));
    // source line 352, bytecode pc 180
    ...
    leftCB: function() {
    // source line 367, bytecode pc 26
    xs.Views.Mgr.hideDialog();
}.bind(this),
    rightCB: function() {
    // source line 370, bytecode pc 26
    xs.Views.Mgr.hideDialog();
    // source line 392, bytecode pc 150
    ...
    var info, add_list;
    if (resData.result) {
        // source line 378, bytecode pc 19
        (info = resData);
        if (info) {
            // source line 381, bytecode pc 39
            (add_list = info.add_list);
            // source line 382, bytecode pc 56
            this.updateInfo(info);
            // source line 383, bytecode pc 126
            (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyPublic));
            if (add_list) {
                // source line 385, bytecode pc 171
    ...
    var cell;
    // source line 403, bytecode pc 17
    (cell = table.dequeueCell());
    if (!cell) {
        // source line 406, bytecode pc 61
        (cell = xs.Views.Dialog.JiFenDuiHuanDialogCell.create());
    }
    // source line 409, bytecode pc 89
    cell.update(this, this.iconDataList[idx]);
    // source line 412, bytecode pc 93
    return cell;
},
    numberOfCellsInTableView: function(table) {
    // source line 417, bytecode pc 11
    return this.iconDataList.length;
}
}));
// source line 423, bytecode pc 978
(xs.Views.Dialog.PublicCopyDialog.showWithSurrenderInfo = function(parent) {
    // source line 428, bytecode pc 102
    ...
    var info;
    if (resData.result) {
        // source line 430, bytecode pc 19
        (info = resData);
        if (info) {
            // source line 435, bytecode pc 74
            xs.Views.Mgr.showDialogByName("PublicCopyDialog", info, parent);
        } else {
            // source line 439, bytecode pc 139
            xs.Views.Mgr.showToast(xs.Tools.String.createString("auto_name_51"));
        }
    }
});
});
// source line 449, bytecode pc 1009
(xs.Views.Dialog.PublicCopyDialog.create = function(param, parent) {
    var ret;
    // source line 450, bytecode pc 28
    (ret = new xs.Views.Dialog.PublicCopyDialog());
    if ((ret && ret.init(param, parent))) {
        // source line 452, bytecode pc 68
        return ret;
    }
    // source line 454, bytecode pc 70
    return null;
});
// source line 460, bytecode pc 1099
xs.Views.Mgr.registerDialog("PublicCopyDialog", {
    "class": xs.Views.Dialog.PublicCopyDialog,
