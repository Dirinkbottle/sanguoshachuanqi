...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Views/Dialog/LabourlDialog.js:1
...
(xs.Views.Dialog.LabourlDialog = xs.Views.HungerLayer.extend({
    name: "xs.Views.Dialog.LabourlDialog",
    cfg: {
    ...
    (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyLabourl));
...
(xs.Views.Dialog.LabourlDialog.showWithSurrenderInfo = function(parent) {
    ...
    if (resData.result) {
        ...
        if (info) {
            ...
            xs.Views.Mgr.showDialogByName("LabourlDialog", info, parent);
        } else {
...
(xs.Views.Dialog.LabourlDialog.create = function(param, parent) {
    var ret;
    // source line 441, bytecode pc 28
    (ret = new xs.Views.Dialog.LabourlDialog());
...
xs.Views.Mgr.registerDialog("LabourlDialog", {
    "class": xs.Views.Dialog.LabourlDialog,
