...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Views/Dialog/DuanWuDialog.js:1
...
(xs.Views.Dialog.JiFenDuiHuanDialogCell = cc.TableViewCell.extend({
    ...
    (this.m_lingshi = xs.Factorys.Sprite.create("SecretShop_icon_jifen1", "SecretShop"));
...
(xs.Views.Dialog.DuanWuDialog = xs.Views.HungerLayer.extend({
    name: "xs.Views.Dialog.DuanWuDialog",
    cfg: {
    ...
    (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyDuanWu));
    ...
    (m_kunYu = xs.Factorys.Sprite.create("SecretShop_icon_jifen1", "SecretShop"));
...
// source line 416, bytecode pc 978
(xs.Views.Dialog.DuanWuDialog.showWithSurrenderInfo = function(parent) {
    // source line 421, bytecode pc 102
    ...
    if (resData.result) {
        ...
        (info = resData);
        if (info) {
            // source line 428, bytecode pc 74
            xs.Views.Mgr.showDialogByName("DuanWuDialog", info, parent);
        } else {
            // source line 432, bytecode pc 139
            xs.Views.Mgr.showToast(xs.Tools.String.createString("auto_name_51"));
        }
    }
});
});
// source line 442, bytecode pc 1009
(xs.Views.Dialog.DuanWuDialog.create = function(param, parent) {
    var ret;
    // source line 443, bytecode pc 28
    (ret = new xs.Views.Dialog.DuanWuDialog());
...
// source line 453, bytecode pc 1099
xs.Views.Mgr.registerDialog("DuanWuDialog", {
    "class": xs.Views.Dialog.DuanWuDialog,
