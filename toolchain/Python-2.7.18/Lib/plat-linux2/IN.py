...
# Included from bits/stdint-uintn.h
...
__STATFS_MATCHES_STATFS64 = 0
__KERNEL_OLD_TIMEVAL_MATCHES_TIMEVAL64 = 0
__FD_SETSIZE = 1024
...
# Included from bits/types/struct_iovec.h
__iovec_defined = 1
...
def __struct_group_tag(TAG): return TAG
...
SO_PEERPIDFD = 77
SO_DEVMEM_LINEAR = 78
SCM_DEVMEM_LINEAR = SO_DEVMEM_LINEAR
SO_DEVMEM_DMABUF = 79
...
# Included from bits/socket-constants.h
SOL_SOCKET = 1
SO_ACCEPTCONN = 30
SO_BROADCAST = 6
SO_DONTROUTE = 5
...
SO_TIMESTAMPNS_NEW = 64
SO_TIMESTAMPING_NEW = 65
SO_RCVTIMEO = SO_RCVTIMEO_NEW
SO_SNDTIMEO = SO_SNDTIMEO_NEW
SO_TIMESTAMP = SO_TIMESTAMP_NEW
SO_TIMESTAMPNS = SO_TIMESTAMPNS_NEW
SO_TIMESTAMPING = SO_TIMESTAMPING_NEW
SO_RCVTIMEO = SO_RCVTIMEO_OLD
SO_SNDTIMEO = SO_SNDTIMEO_OLD
SO_TIMESTAMP = SO_TIMESTAMP_OLD
SO_TIMESTAMPNS = SO_TIMESTAMPNS_OLD
...
# Included from bits/types/struct_osockaddr.h
__osockaddr_defined = 1
...
# Included from bits/endianness.h
