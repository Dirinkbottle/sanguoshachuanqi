...
# Included from bits/select-decl.h
_BITS_SELECT_DECL_H = 1
...
# Included from bits/atomic_wide_counter.h

# Included from bits/struct_mutex.h
_THREAD_MUTEX_INTERNAL_H = 1
__PTHREAD_MUTEX_HAVE_PREV = 1
__PTHREAD_MUTEX_HAVE_PREV = 0
def __PTHREAD_MUTEX_INITIALIZER(__kind): return \

def __PTHREAD_MUTEX_INITIALIZER(__kind): return \


# Included from bits/struct_rwlock.h
def __PTHREAD_RWLOCK_INITIALIZER(__flags): return \
