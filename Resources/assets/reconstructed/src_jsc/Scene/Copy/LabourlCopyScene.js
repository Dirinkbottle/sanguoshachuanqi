...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Scene/Copy/LabourlCopyScene.js:1
...
(xs.Views.CopyLayer = cc.Layer.extend({
    ...
    xs.Views.Dialog.LabourlDialog.showWithSurrenderInfo(self);
},
    onEnter: function() {
...
(xs.Scene.LabourlCopyScene = cc.Scene.extend({
    name: "xs.Scene.LabourlCopyScene",
    ctor: function() {
    ...
    this.m_pageView.addPageWhitConstruct(xs.Tools.String.createString("LabourlCopyTitle"), xs.Views.CopyLayer, { listener: this, param: {} });
...
(xs.Scene.LabourlCopyScene.create = function(param) {
    var sc;
    // source line 775, bytecode pc 23
    (sc = new xs.Scene.LabourlCopyScene());
    if ((sc && sc.init(param))) {
        // source line 778, bytecode pc 59
        return sc;
    }
    // source line 780, bytecode pc 84
    xs.assert(false, "xs.Scene.LabourlCopyScene.create error!");
    // source line 781, bytecode pc 86
    return null;
});
// source line 787, bytecode pc 640
xs.Scene.Mgr.registerScene("LabourlCopyScene", {
    "class": xs.Scene.LabourlCopyScene,
