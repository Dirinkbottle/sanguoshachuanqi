...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Views/Dialog/BuddyInfoDialog.js:1
// source line 23, bytecode pc 93
(xs.Views.Dialog.BuddyInfoDialog = xs.Views.HungerLayer.extend({
    init: function(param) {
    if (!this._super()) {
    ...
    (this.m_mainLayer = xs.Scene.BuddyLayer.create(param));
...
(xs.Views.Dialog.BuddyInfoDialog.create = function(playerId, playerData) {
    var dialog;
    // source line 30, bytecode pc 28
    (dialog = new xs.Views.Dialog.BuddyInfoDialog());
    if ((dialog && dialog.init(playerId, playerData))) {
        // source line 32, bytecode pc 68
        return dialog;
    }
    // source line 34, bytecode pc 91
    xs.warn("xs.Views.Dialog.BuddyInfoDialog.create error!");
    // source line 35, bytecode pc 93
    return null;
});
// source line 40, bytecode pc 204
xs.Views.Mgr.registerDialog("BuddyInfoDialog", { "class": xs.Views.Dialog.BuddyInfoDialog, styleType: xs.Constant_DlgStyleType_Normal });
