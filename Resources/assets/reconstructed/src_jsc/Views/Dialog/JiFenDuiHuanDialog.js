...
// Embedded source: /Users/zhanglinsen/workspace/bianfeng/sgscq1-china-client/projects/sgscq/Resources/src_jsc/Views/Dialog/JiFenDuiHuanDialog.js:1
...
// source line 407, bytecode pc 947
(xs.Views.Dialog.JiFenDuiHuanDialog = xs.Views.HungerLayer.extend({
    name: "xs.Views.Dialog.JiFenDuiHuanDialog",
    cfg: {
    ...
    (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyJiFen));
    ...
    // source line 313, bytecode pc 30
    this.labelCurrencySumNum.setString((this.SumSpiritStoneNum + ""));
    if (isInit) {
        // source line 316, bytecode pc 56
        this.m_tableView.reloadData();
    } else {
        // source line 318, bytecode pc 74
        this.refreshIconList();
    }
},
    onEnter: function() {
    // source line 324, bytecode pc 12
    this._super();
},
    onExit: function() {
    // source line 328, bytecode pc 12
    this._super();
},
    setBaseTouchPriority: function(priority) {
    // source line 332, bytecode pc 9
    (this.m_baseTouchPriority = priority);
    // source line 333, bytecode pc 51
    this.btnClose.setTouchPriority((this.m_baseTouchPriority + this.cfg.btnClose.priority));
    // source line 334, bytecode pc 78
    ...
    if (xs.Utils.isEmpty(itemData)) {
        // source line 340, bytecode pc 37
        return void 0;
    }
    // source line 342, bytecode pc 42
    (promptStr = null);
    // source line 343, bytecode pc 87
    (itemName = xs.Tools.String.createString(itemData.item_name));
    // source line 344, bytecode pc 180
    ...
    leftCB: function() {
    // source line 359, bytecode pc 26
    xs.Views.Mgr.hideDialog();
}.bind(this),
    rightCB: function() {
    // source line 362, bytecode pc 26
    xs.Views.Mgr.hideDialog();
    // source line 384, bytecode pc 150
    ...
    if (resData.result) {
        ...
        (info = resData);
        if (info) {
            // source line 373, bytecode pc 39
            (add_list = info.add_list);
            // source line 374, bytecode pc 56
            this.updateInfo(info);
            // source line 375, bytecode pc 126
            (this.SumSpiritStoneNum = xs.Profile.GameData.Mgr.getInstance().Items.getTotalNumById(xs.Models.ItemID_CopyJiFen));
            if (add_list) {
                // source line 377, bytecode pc 171
    ...
    var cell;
    // source line 395, bytecode pc 17
    (cell = table.dequeueCell());
    if (!cell) {
        // source line 398, bytecode pc 61
        (cell = xs.Views.Dialog.JiFenDuiHuanDialogCell.create());
    }
    // source line 401, bytecode pc 89
    cell.update(this, this.iconDataList[idx]);
    // source line 404, bytecode pc 93
    return cell;
},
...
(xs.Views.Dialog.JiFenDuiHuanDialog.showWithSurrenderInfo = function(parent) {
    // source line 420, bytecode pc 102
    ...
    if (resData.result) {
        ...
        (info = resData);
        if (info) {
            // source line 427, bytecode pc 74
            xs.Views.Mgr.showDialogByName("JiFenDuiHuanDialog", info, parent);
        } else {
            // source line 431, bytecode pc 139
            xs.Views.Mgr.showToast(xs.Tools.String.createString("auto_name_51"));
        }
    }
});
});
// source line 441, bytecode pc 1009
(xs.Views.Dialog.JiFenDuiHuanDialog.create = function(param, parent) {
    var ret;
    // source line 442, bytecode pc 28
    (ret = new xs.Views.Dialog.JiFenDuiHuanDialog());
    if ((ret && ret.init(param, parent))) {
        // source line 444, bytecode pc 68
        return ret;
    }
    // source line 446, bytecode pc 70
    return null;
});
// source line 452, bytecode pc 1099
xs.Views.Mgr.registerDialog("JiFenDuiHuanDialog", {
    "class": xs.Views.Dialog.JiFenDuiHuanDialog,
